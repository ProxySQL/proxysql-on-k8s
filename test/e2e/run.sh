...
SCENARIOS=(scenario_mysql scenario_postgres scenario_multireplica scenario_drift scenario_sqlstatements scenario_runtimereconfig scenario_persistence scenario_psa scenario_delete scenario_rotate scenario_platform scenario_logging)
